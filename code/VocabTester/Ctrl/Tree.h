...
namespace Notify
{
	...
	public:
		...
		virtual bool OnSetFocus (Win::Dow::Handle winFrom, unsigned idFrom)
			{ return false; }
		virtual bool OnBeginLabel(NMTVDISPINFO & nmTvDisp) throw ()
			{ return false; }
		virtual bool OnEndLabel(NMTVDISPINFO & nmTvDisp) throw ()
			{ return false; }
		virtual Keyboard::Handler * GetKeyboardHandler () throw ()
			{ return 0; }
		virtual bool OnBeginDrag(NMHDR * hdr) throw ()
			{ return 0; }
		virtual bool OnRClick (NMHDR * hdr) throw ()
			{ return 0; }
	protected:
