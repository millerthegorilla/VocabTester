...
namespace Win
{
	...
	public:
		...
		public:
			...
			{
				// We use only those two; Other posibilities are: LVIF_PARAM, LVIF_STATE
	...
	public:
		...
		{
			ListView_SetBkColor (H (), bkColor);
			ListView_SetTextBkColor (H (), bkColor);
		}
		...
		{
			Assert (item < _count);
			ListView_EnsureVisible (H (), item, FALSE);
		}
	...
	public:
		...
		public:
			...
			void Image (int iImage, bool imageOnTheRight)
			{
				fmt |= LVCFMT_IMAGE;
				if (imageOnTheRight)
	...
	public:
		...
		void AddColumn (int width, char const * title, ColAlignment align = Left, bool hasImage = false);
		void AddProportionalColumn (int widthPercentage, char const * title, ColAlignment align = Left, bool hasImage = false);
		void DeleteColumn (int iCol);
		void RemoveColumnImage (int iCol);
		void SetColumnImage (int iCol, int iImage, bool imageOnTheRight = true);
		void SetColumnText (int iCol, char const * title, ColAlignment align = Left, bool hasImage = false);
		void ClearAll ();
