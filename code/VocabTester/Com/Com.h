...
namespace Com
{
	...
	public:
		Use ()
		{
			HRESULT err = ::CoInitializeEx (0, COINIT_APARTMENTTHREADED);
			if (err != S_OK && err != S_FALSE)
				throw Win::Exception ("Couldn't initialize COM.");
		}
		~Use ()
		{
			::CoUninitialize ();
	...
	public:
		MainUse ()
		{
			HRESULT hr = ::CoInitializeSecurity (
								...
								0);							// reserved
			if (hr != S_OK)
				throw Win::Exception ("Couldn't initialize security.");
		};
	};
	...
	public:
		UseOle ()
		{
			HRESULT err = ::OleInitialize (0);
			if (err != S_OK)
				throw Win::Exception ("Couldn't initialize OLE");
		}
		~UseOle ()
		{
			::OleUninitialize ();
