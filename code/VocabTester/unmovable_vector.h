...
public:
	...
	{
	public:
		const_iterator (BlocksIter blocksIter, BlocksIter blocksEnd, Block::iterator it, Block::iterator endBlock)
	...
	protected:
		...
		Block::iterator _it;
		Block::iterator _endBlock;
	};

	class iterator: public const_iterator
	{
	public:
		iterator (BlocksIter blocksIter, BlocksIter blocksEnd, Block::iterator it, Block::iterator endBlock)
