...
class DialogController : public Win::Dow
{
  public:
    virtual ~DialogController( void ) {}

    void EndOk( void ) { ::EndDialog(_hwnd, TRUE); }
    void EndCancel( void ) { ::EndDialog(_hwnd, FALSE); }
    ...
    virtual bool OnCompareItem( COMPAREITEMSTRUCT* data, BOOL& result ) { return false; }
    ...
    virtual bool OnDeviceChange( UINT event, DEV_BROADCAST_HDR* data, BOOL& result ) { return false; }
    ...
    virtual bool OnCharToItem( int key, int caretPos, HWND listBox, BOOL& result ) { return false; }
    ...
    virtual bool OnMenuChar( TCHAR ch, Win::MenuFlags const& flags, HMENU hMenu, BOOL& result ) { return false; }
    virtual bool OnMenuSelect( UINT menuItem, Win::MenuFlags const& flags, HMENU hMenu ) { return false; }
    virtual bool OnMouseActivate( HWND topWin, Win::HitTestData const& data, UINT mouseMsg, BOOL& result ) { return false; }
    ...
    virtual bool OnNCActivate( bool active, BOOL& result ) { return false; }
    virtual bool OnNCCalcSize( NCCALCSIZE_PARAMS* data, BOOL& result ) { return false; }
    ...
    virtual bool OnNCHitTest( int x, int y, BOOL& result ) { return false; }
    virtual bool OnNotify( NMHDR* hdr, BOOL& result ) { return false; }
    virtual bool OnNotifyFormat( HWND from, int cmd, BOOL& result ) { return false; }
...
*/
    virtual bool OnPowerBroadcast( DWORD event, DWORD data, BOOL& result ) { return false; }
    ...
    virtual bool OnQueryEndSession( bool logOff, BOOL& result ) { return false; }
    virtual bool OnQueryNewPalette( BOOL& result ) { return false; }
    virtual bool OnQueryOpen( BOOL& result ) { return false; }
    ...
    virtual bool OnSetCursor( HWND hwnd, Win::HitTestData const& data, UINT mouseMsg, BOOL& result ) { return false; }
    virtual bool OnSetFocus( HWND losingWin ) { return false; }
    virtual bool OnSetFont( HFONT hFont, bool redraw ) { return false; }
    virtual bool OnSetText( TCHAR const text[], BOOL& result ) { return false; }
    ...
    virtual bool OnVKeyToItem( int virtKey, int caretPos, HWND listBox, BOOL& result ) { return false; }
    ...
    virtual bool OnUserMessage( UINT msg, WPARAM wParam, LPARAM lParam, BOOL& result ) { return false; }
/*
  protected: // Methods
    DialogController( HWND hwnd )
    : Win::Dow(hwnd)
    {}
*/
};
...
class DlgFactory
{
  public:
    ...
    virtual DialogController* MakeController( HWND dlg ) = 0;
...
class DialogFactory : public DlgFactory
{
  public:
    DialogFactory( ActualArg& arg )
    : DlgFactory(&arg)
    {}

    virtual DialogController* MakeController( HWND hwnd )
    { return new ActualCtrl(hwnd, *reinterpret_cast<ActualArg>(_arg));
    }
};
...
{
  public:
    ModalDialog( Win::Dow parent, int dlgResId, DialogController& ctrl )
    : _result(::DialogBoxParam(parent.GetInstance(), MAKEINTRESOURCE(dlgResId), parent, ModalDialogProc, reinterpret_cast<LPARAM>(&ctrl)))
    {}

    ModalDialog( HINSTANCE hInst, HWND parent, int dlgResId, DialogController& ctrl )
    : _result(::DialogBoxParam(hInst, MAKEINTRESOURCE(dlgResId), parent, ModalDialogProc, reinterpret_cast<LPARAM>(&ctrl)))
    {}
  ...
  private: // Methods
    static BOOL CALLBACK ModalDialogProc( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam );
